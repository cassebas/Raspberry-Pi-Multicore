  ...
  \begin{tikzpicture}
    \begin{axis}
      [
        ...
        ylabel={Cycles},
        flexible xticklabels from table={data/cycles-1core-randomarrayaccess.csv}{pattern}{},
        xtick=data,
      ...
      ] {data/cycles-1core-randomarrayaccess.csv};
      \addlegendentry{Core 0}
    \end{axis}
  \end{tikzpicture}
  \caption{Random array access running on 1 core}
  \label{fig_cycles_randomarrayaccess_1core}
\end{figure}
