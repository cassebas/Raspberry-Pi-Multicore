  ...
  \begin{tikzpicture}
    \begin{axis}
      [
        ...
        ylabel={Cycles},
        flexible xticklabels from table={data/cycles-4core-randomarrayaccess.csv}{pattern}{},
        xtick=data,
      ...
      ] {data/cycles-4core-randomarrayaccess.csv};
      ...
      table [
        x expr = \coordindex,
        y expr = \thisrow{median-randomarrayaccess-core3},
        y error expr = \thisrow{std-randomarrayaccess-core3},
      ] {data/cycles-4core-randomarrayaccess.csv};
      \addlegendentry{Core 3}
    \end{axis}
  \end{tikzpicture}
  \caption{Random array access running on 4 cores}
  \label{fig_cycles_randomarrayaccess_4core}
\end{figure}
