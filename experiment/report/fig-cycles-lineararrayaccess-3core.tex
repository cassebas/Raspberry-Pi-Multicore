  ...
  \begin{tikzpicture}
    \begin{axis}
      [
        ...
        ylabel={Cycles},
        flexible xticklabels from table={data/cycles-3core-lineararrayaccess.csv}{pattern}{},
        xtick=data,
      ...
      ] {data/cycles-3core-lineararrayaccess.csv};
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{Linear array access running on 3 cores}
  \label{fig_cycles_lineararrayaccess_3core}
\end{figure}
