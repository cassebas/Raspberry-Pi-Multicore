  ...
  \begin{tikzpicture}
    \begin{axis}
      [
        ...
        ylabel={Cycles},
        flexible xticklabels from table={data/cycles-2core-lineararrayaccess.csv}{pattern}{},
        xtick=data,
      ...
      ] {data/cycles-2core-lineararrayaccess.csv};
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{Linear array access running on 2 cores}
  \label{fig_cycles_lineararrayaccess_2core}
\end{figure}
