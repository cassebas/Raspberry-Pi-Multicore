...
#define BENCH_INIT1_CORE1 Array1 = (volatile int*) malloc(sizeof(int) * MALARDALEN_BSORT_INPUTSIZE);
#define BENCH_INIT1_CORE2 mydata2 = (bigstruct_t*) malloc(sizeof(bigstruct_t) * SYNBENCH_DATASIZE);
